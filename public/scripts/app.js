...
var RandomApp = function (_React$Component) {
  ...
  function RandomApp() {
    ...
    return _possibleConstructorReturn(this, (RandomApp.__proto__ || Object.getPrototypeOf(RandomApp)).apply(this, arguments));
  }

  _createClass(RandomApp, [{
    key: "render",
    value: function render() {
      var title = "Random App";
      var subtitle = "Sort some things";
      var options = ['Roleta', 'Veganos', 'Sabores da terra'];
